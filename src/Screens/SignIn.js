...
const SignIn = () => {
  ...
  return (
    <div className="grid lg:grid-cols-2">
      {/* first column */}
      <div className=" lg:h-[1000px] h-[500px] bg-cover rounded-3xl text-white flex justify-center items-center shadow-2xl">
      ...
      <div className="lg:ml-0 lg:mt-0 mt-[-70px]  lg:col-start-2 lg:col-end-3 bg-white rounded-[40px] h-[300px] ">
        ...
        <div className="">
          <div className="lg:flex hidden  justify-end">
            <img
              alt="/"
              className="h-[50px] lg:flex justify-end hidden m-5"
              src={logo}
            />
          </div>
        ...
        <div className="flex justify-center lg:mt-32 mt-12 h-full">
          <div className="flex flex-col">
            <h1 className="font-bold lg:text-[50px] text-[35px] flex justify-start">
              WELCOME Back !
            </h1>
            <h1 className="lg:text-[15px] text-[12px] flex justify-start font-thin">
              Sign in to your account and enjoy learning.
            </h1>
            <form
            ...
            >
              <div className="flex flex-col lg:space-y-10 space-y-5 ">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <a
                    href="/"
                    className="text-sm font-medium text-purple-600 hover:underline focus:outline-none focus:underline"
                  >
                    Forgot Password?
                  </a>
                </div>
                ...
                <div className=" flex justify-start">
                  <h1 className="text-[14px]">
                    New User?{" "}
                    <span className="underline text-purple-600"> Sign Up</span>
                  </h1>
                </div>
              </div>
            </form>
